...
public class MessageListener {
    ...
    public void receiveMessageFromApp1(Userdetails data) {
        ...
        try {
            ...
            if (ex.getStatusCode() == HttpStatus.NOT_FOUND) {
                ...
                // Note: Typically Application specific exception should be
                // thrown below
    ...
    public void receiveMessageForApp2(String reqObj) {
        ...
        try {
            ...
            if (ex.getStatusCode() == HttpStatus.NOT_FOUND) {
                ...
                // Note: Typically Application specific exception can be thrown
                // below
                throw new RuntimeException();
            } else {
                throw new AmqpRejectAndDontRequeueException(ex);
